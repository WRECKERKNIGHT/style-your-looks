...
echo
echo "  Next steps:"
echo "   1. Edit .env.local and paste your Supabase project URL + anon key"
echo "      (project settings → API). Keep the NEXT_PUBLIC_ prefix on both."
echo "   2. Apply the migrations in ./supabase/migrations (001 … 006) in order:"
echo "        npx supabase db push"
echo "      or paste each file into your Supabase SQL editor, oldest first."
