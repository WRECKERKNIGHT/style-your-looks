        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12">
          <div className="lg:col-span-2 space-y-5">
            ...
            <div className="flex items-center gap-3 mt-6">
              <a href="#" className="w-9 h-9 rounded-lg glass-card flex items-center justify-center hover:border-[var(--accent-caramel)] transition-colors" aria-label="Twitter">
                <svg className="w-4 h-4 text-[var(--accent-mocha)]" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </a>
              <a href="#" className="w-9 h-9 rounded-lg glass-card flex items-center justify-center hover:border-[var(--accent-caramel)] transition-colors" aria-label="Instagram">
                <svg className="w-4 h-4 text-[var(--accent-mocha)]" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" className="w-9 h-9 rounded-lg glass-card flex items-center justify-center hover:border-[var(--accent-caramel)] transition-colors" aria-label="GitHub">
                <svg className="w-4 h-4 text-[var(--accent-mocha)]" fill="currentColor" viewBox="0 0 24 24">
