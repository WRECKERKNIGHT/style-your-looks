  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-light-base dark:bg-cosmic-base gap-6">
      <div className="relative w-14 h-14">
        <div className="absolute inset-0 border-2 border-aurum-500/20 rounded-[var(--radius-xs)]" />
        <div className="absolute inset-0 border-2 border-aurum-500 border-t-transparent rounded-[var(--radius-xs)] animate-spin" />
