...
function generateReport(face: any, body: any, color: any) {
  ...
  svg.innerHTML = `
    ...
    <text x="${w/2}" y="${h - 55}" text-anchor="middle" font-family="Arial, sans-serif" font-size="9" fill="#C8963E">Generated by AURAYA</text>
    <text x="${w/2}" y="${h - 40}" text-anchor="middle" font-family="Arial, sans-serif" font-size="8" fill="#C8963E">auraya.app</text>
  `;
  ...
  img.onload = () => {
    ...
    link.download = "auraya-report.png";
